    ...
    return (
        <nav className="fixed top-8 left-0 px-8 w-full z-50">
            <ul className="grid grid-cols-3 items-center justify-between w-full">
                <li></li>
                <li className="flex justify-center items-center text-base lg:text-xl text-zinc-700 font-maghfirea cursor-pointer self-center text-center">Meryl Edition</li>
